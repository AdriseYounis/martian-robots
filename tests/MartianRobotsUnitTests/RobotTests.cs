...
public class Tests
{
    ...
    [Test]
    public void MoveRobot_LeftAndForward()
    {
        this.Given(_ => ADirection(new West()))
            .And(_ => TheRobotPosition(new Coordinates(0,3)))
            .When(_ => TheRobotExecutesTheCommand("LLFFFLFLFLF"))
            .Then(_ => TheExpectedPositionIs("2 3 S"))
            .BDDfy();
    }
